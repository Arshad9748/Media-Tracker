...
export const register = async (req, res) =>{
    ...
    const token = jwt.sign({id: newUser.rows[0].id}, process.env.JWT_SECRET, {expiresIn: '6d'})
...
export const login = async (req, res) => {
    ...
    try{
        ...
        const token = jwt.sign({id: user.rows[0].id}, process.env.JWT_SECRET, {expiresIn: '6d'})
